...
public class UpdateUtil {
    ...
    private static final String PREFS = "com.yzwl.ssmd.prefs";
    private static final String PREFS_IGNORE = "com.yzwl.ssmd.ignore";
    private static final String PREFS_UPDATE = "com.yzwl.ssmd.update";
    ...
    public static void install(Context context, File file, boolean force) {
        Logger.e(TAG, "context=" + context + "，file=" + file);
