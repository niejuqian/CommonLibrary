...
import com.laonie.common.util.DateUtils;
...
//		headerProgressBar.setVisibility(View.GONE);
		...
		layoutParamsWW.width = UIUtils.scaleValue(mContext, 65);
		layoutParamsWW.height = UIUtils.scaleValue(mContext, 65);
//		headImage.addView(arrowImageView,layoutParamsWW);
		...
		UIUtils.setPadding(headTextLayout,0, 0, 0, 0);
		...
		UIUtils.setTextSize(tipsTextview,30);
		UIUtils.setTextSize(headerTimeView,27);
...
//					arrowImageView.clearAnimation();
//				}
				tipsTextview.setText(getResources().getString(R.string.pulldownrefresh));

				if(lastRefreshTime==null){
					lastRefreshTime = DateUtils.getCurrentDate(DateUtils.TIME_FORMAT);
					headerTimeView.setText(getResources().getString(R.string.refreshtime) + lastRefreshTime);
				}else{
					headerTimeView.setText(getResources().getString(R.string.lastrefreshtime) + lastRefreshTime);
				}
...
//					arrowImageView.startAnimation(mRotateUpAnim);
					tipsTextview.setText(getResources().getString(R.string.releasetorefresh));
					headerTimeView.setText(getResources().getString(R.string.lastrefreshtime) + lastRefreshTime);
					lastRefreshTime = DateUtils.getCurrentDate(DateUtils.TIME_FORMAT);
			...
			case STATE_REFRESHING:
				...
				headerTimeView.setText(getResources().getString(R.string.thisrefreshtime) + lastRefreshTime);
				break;
			default:
		}
